...
#linken
gcc -o test main.o shader.o renderobject.o view.o matrix.o key.o bmp_rw.o -lbcm_host -lEGL -lGLESv2 -lm -L/home/felix/Entwicklung/userland/userland-master/build/lib
cd ..
